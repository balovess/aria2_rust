...
impl StreamFilter for BZip2Decoder {
    ...
    fn filter(&mut self, input: &[u8]) -> Result<Vec<u8>> {
        ...
        match decoder.read_to_end(&mut output) {
            ...
            Err(e) => Err(Aria2Error::Io(format!("BZip2 decompression failed: {}", e))),
        }
    }
...
mod tests {
    ...
    fn create_bzip2_hello_world() -> Vec<u8> {
        ...
        vec![
            0x42, 0x5a, 0x68, 0x39, 0x31, 0x41, 0x59, 0x26, 0x53, 0x59, 0x99, 0xac, 0x22, 0x56,
            0x00, 0x00, 0x02, 0x57, 0x80, 0x00, 0x10, 0x60, 0x04, 0x00, 0x40, 0x00, 0x80, 0x06,
            0x04, 0x90, 0x00, 0x20, 0x00, 0x22, 0x06, 0x81, 0x90, 0x80, 0x69, 0xa6, 0x89, 0x18,
            0x6a, 0xce, 0xa4, 0x19, 0x6f, 0x8b, 0xb9, 0x22, 0x9c, 0x28, 0x48, 0x4c, 0xd6, 0x11,
            0x2b, 0x00,
        ]
    }
