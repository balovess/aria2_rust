...
#   or
#   irm https://raw.githubusercontent.com/balovess/aria2_rust/main/install.ps1 | iex; Install-Aria2Rust -Version "v0.2.9"
#
# Options:
...
if ($Help) {
    ...
    Write-Host '  irm https://raw.githubusercontent.com/balovess/aria2_rust/main/install.ps1 | iex; Install-Aria2Rust -Version "v0.2.9"'
    Write-Host ""
...
function Install-Aria2Rust {
    ...
    if ($Version -eq "latest") {
        ...
        if ([string]::IsNullOrEmpty($Version)) {
            Write-Warning "Could not determine latest version, using v0.2.9"
            $Version = "v0.2.9"
        }
    }
